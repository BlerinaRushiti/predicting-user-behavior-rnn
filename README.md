...
### Heqja e Regjistrimeve të Dublikuara
...
Kolona event_time u konvertua në formatin datetime duke përdorur UTC, në mënyrë që informacioni kohor të mund të përdorej në mënyrë të saktë gjatë organizimit të ndërveprimeve.

### Renditja Kronologjike
Të dhënat u renditën sipas user_session dhe event_time, duke siguruar që ndërveprimet brenda secilit sesion të ishin në rend kronologjik.
...
Kjo shpërndarje tregon një pabalancim të konsiderueshëm ndërmjet klasave, ku view përbën shumicën dërrmuese të ndërveprimeve.
...
Pas krijimit të sekuencave, ato u renditën në mënyrë kronologjike sipas kohës së ndërveprimit target, për të ruajtur rendin kohor të të dhënave.
...
Për të shmangur përdorimin e informacionit nga e ardhmja gjatë trajnimit, u përdor një ndarje kronologjike e të dhënave. 80% e sekuencave u përdorën për trajnim, ndërsa 20% u përdorën për testim.
...
## Eksperimentet Para Balancimit të Klasave
...
### Matricat e Konfuzionit Para Balancimit
...
## Eksperimentet Pas Balancimit të Klasave
...
[Hap notebook-un](notebooks/user_behavior_prediction_lstm.ipynb)
